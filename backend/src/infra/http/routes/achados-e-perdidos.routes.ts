...
achadosEPerdidosRouter.post('/', criarItemController.handle);
achadosEPerdidosRouter.get('/', listarItensController.handle);
achadosEPerdidosRouter.get('/:id', buscarItemPorIdController.handle);
achadosEPerdidosRouter.patch('/:id/status', atualizarStatusController.handle);
achadosEPerdidosRouter.delete('/:id', deletarItemController.handle);
