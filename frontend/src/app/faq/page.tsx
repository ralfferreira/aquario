  ...
  return (
    <main className="flex flex-col items-center min-h-screen bg-gray-50 dark:bg-black">
      <div className="w-[90%] max-w-4xl bg-gradient-to-r from-[#2E18AA] to-[#B207D4] text-white py-16 px-8 text-left rounded-lg mt-16">
        ...
        <p className="mt-2 text-lg">Veja as dúvidas mais frequentes, documentos mais importantes, guias e o seletor de cadeiras de seu curso</p>
      </div>

      <section className="w-full max-w-4xl mt-8 px-4 text-left">
        <h3 className="text-lg font-medium mb-8 text-gray-800 dark:text-gray-200">Selecione o curso</h3>
        <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Centro de informática</h2>
