      ...
      <div className="space-y-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="relative">
              ...
              <CardHeader className="opacity-40">
                <CardTitle className="flex items-center gap-2">📝 Blog & Publicações</CardTitle>
                <CardDescription>Compartilhamento de conhecimento e informações</CardDescription>
              </CardHeader>
            ...
            <Card className="relative">
              ...
              <CardHeader className="opacity-40">
                ...
                <CardDescription>Banco de dados de laboratórios verificados</CardDescription>
              </CardHeader>
              <CardContent className="opacity-40">
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card className="relative">
              ...
              <CardHeader className="opacity-40">
                <CardTitle className="flex items-center gap-2">💼 Vagas & Oportunidades</CardTitle>
                <CardDescription>Central de vagas de estágio e emprego</CardDescription>
              </CardHeader>
              <CardContent className="opacity-40">
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card className="relative">
              ...
              <CardHeader className="opacity-40">
                <CardTitle className="flex items-center gap-2">🔍 Achados e Perdidos</CardTitle>
                <CardDescription>Sistema automatizado e manual</CardDescription>
              </CardHeader>
              <CardContent className="opacity-40">
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card className="relative border-green-200 bg-green-50/50 dark:border-green-800 dark:bg-green-950/20">
              ...
              <CardHeader>
                <CardTitle className="flex items-center gap-2">❓ FAQ & Guias</CardTitle>
                <CardDescription>Orientações para alunos iniciantes</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card className="relative">
              ...
              <CardHeader className="opacity-40">
                <CardTitle className="flex items-center gap-2">🔗 Centralização</CardTitle>
                <CardDescription>Tudo em um só lugar</CardDescription>
              </CardHeader>
              <CardContent className="opacity-40">
                <ul className="space-y-2 text-sm text-muted-foreground">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto">
            O objetivo do projeto Aquário é centralizar as informações do CI e oferecer uma solução
            eficiente para problemas de comunicação e disseminação de informações, facilitando o
            acesso e o compartilhamento de informações importantes entre todos os membros da
        ...
        <section className="bg-muted/50 rounded-xl p-8 text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            O Aquário é um projeto open source e as contribuições são muito bem-vindas! Este projeto
